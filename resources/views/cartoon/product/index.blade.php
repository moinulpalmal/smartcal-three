                ...
                <form method="post" id="FactoryAdd" enctype="multipart/form-data">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Product</strong> Insert/Update Form</h1>
                        ...
                        <div class="tile-body">
                            ...
                            <div class="row" style="padding: 0px 15px;">
                                ...
                                <div class="col-md-2 no-padding">
                                    <div class="form-group">
                                        <label class="checkbox checkbox-custom-alt checkbox-custom-lg" style="padding-top: 17px">
                                            <input name="IsBoard" id="IsCHO" type="checkbox"><i></i> <strong>Is Board ?</strong>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-1 no-padding"></div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label class="checkbox checkbox-custom-alt checkbox-custom-lg" style="padding-top: 17px">
                                            <input name="has_sub_measurement" id="HasSub" type="checkbox"><i></i> <strong>Has Sub Measurement?</strong>
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered table-condensed table-responsive" id="advanced-usage">
                                ...
                                <tr style="background-color: #1693A5; color: white;">
                                    ...
                                    <th class="text-center">Carton/Board</th>
                                    <th class="text-center">Name</th>
                                    <th class="text-center">Has Sub Measurement</th>
                                ...
                                @foreach($products as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a title="Conversion Rate Setup" class="btn btn-info btn-xs" href="{{route('cartoon.product.detail', ['id' => $item->id])}}"><i class="fa fa-eye"></i></a>
        ...
        $('#advanced-usage').on('click',".EditFactory", function(){
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if (data.has_sub_measurement == 1)
                    {
                        $('input[name=has_sub_measurement]').prop('checked', true);
                    }
                    else if (data.has_sub_measurement == 0)
                    {
                        $('input[name=has_sub_measurement]').prop('checked', false);
                    }
                },
                error:function(error){
                    swal({
