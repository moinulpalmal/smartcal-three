                                            ...
                                            <table class="table table-hover table-condensed" id="items">
                                                <thead>
                                                    <tr style="height: 3px !important;">
                                                        ...
                                                        <th class="text-uppercase text-center" style=" font-size: xx-small !important;">Length</th>
                                                        <th class="text-uppercase text-center" style=" font-size: xx-small !important;">Width</th>
                                                        <th class="text-uppercase text-center" style=" font-size: xx-small !important;">Height</th>
                                                        ...
                                                        <th class="text-uppercase text-center" style="font-size: xx-small !important;">Unit SQM Price</th>
                                                        <th class="text-uppercase text-center" style="font-size: xx-small !important;">Per Carton/Board Value</th>
                                                ...
                                                @foreach($details as $item)
                                                    @if($item->cartoon_product_setup_id == $uproduct->id)
                                                        <tr style="height: 1px !important;">
                                                            ...
                                                            <td style="font-size: small !important;"><p>{!! $item->length !!}</p></td>
                                                            <td style="font-size: small !important;"><p>{!! $item->width !!}</p></td>
                                                            <td style="font-size: small !important;"><p>{!! $item->height !!}</p></td>
                                                            ...
                                                            @if($item->no_cal == true)
                                                                <td style="font-size: small !important;" class="text-center"><P>-</P></td>
                                                                @else
                                                            <td style="font-size: small !important;" class="text-right"><P>$ {!! number_format($item->unit_per_square_meter_price, 3, '.', ',') !!}</P></td>
                                                            @endif
                                                            @if($item->no_cal == true)
                                                                <td style="font-size: small !important;" class="text-right"><P>$ {!! number_format($item->unit_per_square_meter_price, 3, '.', ',') !!}</P></td>
                                                            @else
                                                                <td style="font-size: small !important;" class="text-right"><P>$ {!! number_format($item->per_square_meter_price  , 3, '.', ',') !!}</P></td>
                                                            @endif
                                                            <td style="font-size: small !important;" class="text-right"><P>$ {!!  number_format($item->total_price, 3, '.', ',') !!}</P></td>
                                                            <td style="font-size: small !important;" class="text-right"><P>{!! $item->remarks !!}</P></td>
                                                        </tr>
                                                    @endif
                                                @endforeach
                                                </tbody>
                                        ...
                                        <hr>
                                            <div class="table-responsive">
                                                <table class="table table-hover table-condensed" id="items">
                                                    <tfoot>
                                                    <tr style="height: 3px !important;">
                                                        <td style="font-size: small !important;" class="text-right"><p><b>Total Order Quantity:</b></p></td>
                                                        <td style="font-size: small !important;" class="text-right">
                                                            <P>
                                                                <b>
                                                                    {!! number_format($total_order_quantity, 0, '.', ',') !!}
                                                                </b>
                                                            </P>
                                                        </td>
                                                        <td style="font-size: small !important;" class="text-right"><p><b>Total Amount:</b></p></td>
                                                        <td style="font-size: small !important;" class="text-right">
                                                            <P>
                                                                <b>
