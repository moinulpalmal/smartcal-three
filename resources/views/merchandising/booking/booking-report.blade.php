...
@section('content')
    ...
    <div class="page page-dashboard">
        <div class="pageheader">
            <h2>Merchandising <span> Booking Report</span></h2>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('merchandising.booking.report')}}"> Booking Report</a>
                    </li>
                    <li>
        ...
        <div class="add-nav">
            <div class="nav-heading">
                <h3><strong class="text-greensea">Booking Report</strong></h3>
                <span class="controls pull-right">
                    <a href="{{route('merchandising.booking.report')}}" class="btn btn-ef btn-ef-1 btn-ef-1-default btn-ef-1a btn-rounded-20 mr-5" data-toggle="tooltip" title="Back"><i class="fa fa-times"></i></a>
                                       ...
                                       {{-- <div class="row b-t pt-20">
                                            ...
                                            <div class="col-md-6 text-left">
                                                <ul class="list-unstyled text-default lt mb-20">
                                                    <li style="font-size: medium;"><strong>Booking Report</strong></li>
                                                </ul>
                                            </div>
                                            ...
                                            <table class="table table-hover table-condense table-success" id="items">
                                                <thead>
                                                    <tr style="height: 3px !important;">
                                                        ...
                                                        <th class="text-uppercase text-center" style=" font-size: small !important;">Product Group</th>
                                                ...
                                                @foreach($purchaseOrders as $item)
                                                    <tr>
                                                        ...
                                                        <td class="text-left" style=" font-size: x-small !important;">{{(App\Helpers\Helper::IDwiseData('product_groups','id',$item->product_group_id))->group_name}}</td>
