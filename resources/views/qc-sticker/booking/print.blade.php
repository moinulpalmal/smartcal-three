        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('qcsticker.booking.detail', ['id' => $master->id ])}}"> LPD PO NO: {{$master->lpd_po_no}}</a>
                    </li>
                    <li>
                        <a href="#"> Print View</a>
                    </li>
        ...
        <div class="add-nav">
            <div class="nav-heading">
                ...
                <span class="controls pull-right">
                    <a href="{{route('qcsticker.booking.detail', ['id' => $master->id ])}}" class="btn btn-ef btn-ef-1 btn-ef-1-default btn-ef-1a btn-rounded-20 mr-5" data-toggle="tooltip" title="Back"><i class="fa fa-times"></i></a>
                                    ...
                                    @foreach($uniqueProducts as $uproduct)
                                            ...
                                            <table class="table table-hover table-condensed" id="items">
                                                <thead>
                                                    <tr style="height: 3px !important;">
                                                        ...
                                                        <th class="text-uppercase text-center" style=" font-size: xx-small !important;">Sl. No.</th>
                                                ...
                                                @foreach($details as $item)
                                                    @if($item->q_c_sticker_product_setup_id == $uproduct->id)
                                                        <tr style="height: 1px !important;">
                                                            ...
                                                            <td style="font-size: small !important;"><p>{{ $item->sl_no }}</p></td>
                                                            ...
                                                            <td style="font-size: small !important;" class="text-right"><P>$ {!! number_format($item->unit_price  , 6, '.', ',') !!}</P></td>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover table-condensed" id="items">
                                                <tfoot>
                                                <tr style="height: 3px !important;">
                                                    <td colspan="3" style="font-size: small !important;" class="text-right"><p><b>Total:</b></p></td>
