...
@section('content')
    ...
    <div class="page page-profile">
        <div class="pageheader">
            <h2>QC Sticker <span>// Detail</span></h2>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('qcsticker.product')}}"> Product Setup</a>
                    </li>
                    <li>
                        <a href="{{route('qcsticker.product.detail', ['id' => $product->id])}}"> {{$product->name}}</a>
                    </li>
                </ul>
            </div>
        </div>
                                                        ...
                                                        <section class="tile">
                                                            ...
                                                            <div class="tile-body">
                                                                <div class="row" style="padding: 0px 15px;">
                                                                    <input type="hidden" id="PSetupID" name="q_c_sticker_product_setup_id" value="{{old('q_c_sticker_product_setup_id', $product->id)}}">
                                                                    ...
                                                                    {{-- <div class="col-md-4 no-padding">
                                                                        <div class="form-group">
                                                                             <label for="FactoryName" class="control-label">Color + Sl. No.</label>
...
{{--                                                                            <th class="text-center">Color + Sl. No</th>--}}
                                                                            <th class="text-center">Per DZ Unit Price</th>
    ...
    <script>
        ...
        $(function(){
            ...
            $('#ItemAdd').submit(function(e){
                ...
                //return;
                var url = '{{ route('qcsticker.product.save-price-setup') }}';
                //console.log(data);
                $.ajax({
                    url: url,
                    method:'POST',
        ...
        $('#advanced-usage').on('click',".EditFactory", function(){
            ...
            var url = '{{ route('qcsticker.product.edit-price-setup') }}';
            $.ajax({
                url: url,
                method:'POST',
                data:{id: FactoryID},
                success:function(data){
                    $('input[name=q_c_sticker_product_setup_id]').val(data.q_c_sticker_product_setup_id);
        ...
        $('#advanced-usage').on('click',".DeleteDetail", function(){
            ...
            var url = '{{ route('qcsticker.product.delete-price-setup') }}';
            swal({
                title: 'Are you sure?',
