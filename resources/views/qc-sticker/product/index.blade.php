...
@section('content')
    ...
    <div class="page page-dashboard">
        <div class="pageheader">
            <h2>QC Sticker <span>Setup</span></h2>
            <div class="page-bar">
                ...
                <form method="post" id="FactoryAdd" enctype="multipart/form-data">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>QC Sticker</strong> Insert/Update Form</h1>
...
{{--                                    <th class="text-center">Gross Form Factor</th>--}}
                                ...
                                @foreach($products as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a title="Conversion Rate Setup" class="btn btn-info btn-xs" href="{{route('qcsticker.product.detail', ['id' => $item->id])}}"><i class="fa fa-eye"></i></a>
       ...
       /* $(window).load(function(){
        ...
        $(function(){
            ...
            $('#FactoryAdd').submit(function(e){
                ...
                //console.log(data);
                var url = '{{ route('qcsticker.product.save') }}';
                //console.log(data);
                $.ajax({
                    url: url,
                    method:'POST',
        ...
        $('#advanced-usage').on('click',".EditFactory", function(){
            ...
            var url = '{{ route('qcsticker.product.edit') }}';
            $.ajax({
                url: url,
                method:'POST',
                data:{id: FactoryID},
