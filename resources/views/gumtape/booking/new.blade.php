    ...
    <div class="page page-dashboard">
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('gumtape.booking.new')}}"> New Booking</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <!-- tile -->
                <form method="post" id="UserCreatForm" name="UserCreatForm" action="{{route('gumtape.booking.save')}}" enctype="multipart/form-data" >
                    {{ csrf_field() }}
                    <section class="tile">
                        <!-- tile header -->
                                ...
                                @endif
                                    ...
                                    <div class="col-md-3 no-padding">
                                        <div class="form-group">
                                            ...
                                            <input id="Styles" maxlength="5000" type="text" class="form-control @error('style') is-invalid @enderror" name="style" value="{{ old('style') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3 no-padding">
                                        <div class="form-group">
                                            <label for="Consumption" class="control-label">Consumption / DZ</label>
                                            <input id="Consumption" type="text" class="form-control @error('consumption_per_dz') is-invalid @enderror" name="consumption_per_dz" value="{{ old('consumption_per_dz') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3 no-padding">
                                        <div class="form-group">
                                            <label for="GarmentsQty" class="control-label">Garments Quantity</label>
                                            <input id="GarmentsQty" type="number" class="form-control @error('garments_quantity') is-invalid @enderror" name="garments_quantity" value="{{ old('garments_quantity') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row" style="padding: 0px 15px;">
