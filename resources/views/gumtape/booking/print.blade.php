        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('gumtape.booking.detail', ['id' => $master->id ])}}"> LPD PO NO: {{$master->lpd_po_no}}</a>
                    </li>
                    <li>
                        <a href="#"> Print View</a>
                    </li>
        ...
        <div class="add-nav">
            <div class="nav-heading">
                ...
                <span class="controls pull-right">
                    <a href="{{route('gumtape.booking.detail', ['id' => $master->id ])}}" class="btn btn-ef btn-ef-1 btn-ef-1-default btn-ef-1a btn-rounded-20 mr-5" data-toggle="tooltip" title="Back"><i class="fa fa-times"></i></a>
                                                ...
                                                @foreach($details as $item)
                                                    @if($item->gum_tape_product_setup_id == $uproduct->id)
                                                        <tr style="height: 1px !important;">
                                                            ...
                                                            <td style="font-size: small !important;" class="text-left"><p>{!! $item->size !!}</p></td>
                                                ...
                                                <tfoot>
                                                    <tr style="height: 3px !important;">
                                                        ...
                                                        <td style="font-size: small !important;" class="text-right">
                                                            ...
                                                            <P>
                                                                <b>
                                                                    $ {!! number_format($total_price_usd, 2, '.', ',') !!}
                                                                </b>
                                                            </P>
                                                            @endif
                                                            @if($total_price_bdt != 0)
                                                                <br>
                                                                <P>
                                                                    <b>
                                                                        ৳ {!! number_format($total_price_bdt, 2, '.', ',') !!}
                                                                    </b>
                                                                </P>
                                                                @endif
                                                        </td>
