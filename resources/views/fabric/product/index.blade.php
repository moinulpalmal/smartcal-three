        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('fabric.product')}}"> Fabric Setup</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <form method="post" id="FactoryAdd" enctype="multipart/form-data">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Fabric</strong> Insert/Update Form</h1>
...
{{--                                    <th class="text-center">Gross Form Factor</th>--}}
                                ...
                                @foreach($products as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a title="Conversion Rate Setup" class="btn btn-info btn-xs" href="{{route('fabric.product.detail', ['id' => $item->id])}}"><i class="fa fa-eye"></i></a>
       ...
       /* $(window).load(function(){
        ...
        $(function(){
            ...
            $('#FactoryAdd').submit(function(e){
                ...
                //console.log(data);
                var url = '{{ route('fabric.product.save') }}';
                //console.log(data);
                $.ajax({
                    url: url,
                    method:'POST',
        ...
        $('#advanced-usage').on('click',".EditFactory", function(){
            ...
            var url = '{{ route('fabric.product.edit') }}';
            $.ajax({
                url: url,
                method:'POST',
                data:{id: FactoryID},
