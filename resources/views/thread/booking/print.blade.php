        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('thread.booking.detail', ['id' => $master->id ])}}"> LPD-3 PO NO: {{$master->lpd_po_no}}</a>
                    </li>
                    <li>
                        <a href="#"> Print View</a>
                    </li>
        ...
        <div class="add-nav">
            <div class="nav-heading">
                ...
                <span class="controls pull-right">
                    <a href="{{route('thread.booking.detail', ['id' => $master->id ])}}" class="btn btn-ef btn-ef-1 btn-ef-1-default btn-ef-1a btn-rounded-20 mr-5" data-toggle="tooltip" title="Back"><i class="fa fa-times"></i></a>
                                            ...
                                            <table class="table table-hover table-condensed" id="items">
                                                <thead>
                                                    <tr style="height: 3px !important;">
                                                        ...
                                                        <th class="text-uppercase text-center" style=" font-size: xx-small !important;">Shade</th>
                                                        <th class="text-uppercase text-center" style=" font-size: xx-small !important;">Length Per Con</th>
                                                        <th class="text-uppercase text-center" style=" font-size: xx-small !important;">G. Qty</th>
                                                ...
                                                @foreach($details as $item)
                                                    @if($item->thread_product_setup_id == $uproduct->id)
                                                        <tr style="height: 1px !important;">
                                                            ...
                                                            <td style="font-size: small !important;" class="text-center"><p>{!! $item->shade !!}</p></td>
                                                            <td style="font-size: small !important;" class="text-right"><P>{!! number_format($item->per_con_length, 0, '.', ',') !!}</P></td>
                                                            <td style="font-size: small !important;" class="text-right"><P>{!! number_format($item->garments_order_quantity, 0, '.', ',') !!}</P></td>
                                                            <td style="font-size: small !important;" class="text-right"><P>{!! number_format($item->order_quantity, 0, '.', ',') !!}</P></td>
                                                            <td style="font-size: small !important;" class="text-center"><p>{!! (\App\Helpers\Helper::IDwiseData('units', 'id', $item->input_unit_id))->short_unit !!}</p></td>
                                                            <td style="font-size: small !important;" class="text-right"><P>$ {!! number_format($item->unit_price  , $item->decimal_count, '.', ',') !!}</P></td>
                                                            <td style="font-size: small !important;" class="text-right"><P>$ {!!  number_format($item->total_price, $item->decimal_count, '.', ',') !!}</P></td>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        <td style="font-size: small !important;" colspan="4" class="text-right text-strong"><p>Total:</p></td>
                                                        <td style="font-size: small !important;" class="text-right"><P>{!! number_format((\App\Helpers\Helper::GetThreadPOTotalQty($master->id, $uproduct->id)), 0, '.', ',') !!}</P></td>
                                                        <td style="font-size: small !important;" class="text-right" colspan="3"><P>$ {!! number_format((\App\Helpers\Helper::GetThreadPOTotalPrice($master->id, $uproduct->id))  , 3, '.', ',') !!}</P></td>
                            ...
                            <div class="col-md-12">
                                ...
                                <section class="tile tile-simple bg-tr-black lter">
                                    ...
                                    <div class="tile-footer">
                                        <p class="text-right" style="font-size: small !important;">Order Generated From <strong>"Smart Cal"</strong>-Date:{{ \Carbon\Carbon::now()->format('d/m/Y') }}</p>
                                    </div>
                                </section>
                                <!-- /tile -->
                            </div>
