        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('thread.product')}}"> Thread Setup</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <form method="post" id="FactoryAdd" enctype="multipart/form-data">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Thread</strong> Insert/Update Form</h1>
                            ...
                            <table class="table table-hover table-bordered table-condensed table-responsive" id="advanced-usage">
                                ...
                                @foreach($products as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a title="Detail Setup" class="btn btn-info btn-xs" href="{{route('thread.product.detail', ['id' => $item->id])}}"><i class="fa fa-eye"></i></a>
       ...
       /* $(window).load(function(){
        ...
        $(function(){
            ...
            $('#FactoryAdd').submit(function(e){
                ...
                //console.log(data);
                var url = '{{ route('thread.product.save') }}';
                //console.log(data);
                $.ajax({
                    url: url,
                    method:'POST',
        ...
        $('#advanced-usage').on('click',".EditFactory", function(){
            ...
            var url = '{{ route('thread.product.edit') }}';
            $.ajax({
                url: url,
                method:'POST',
                data:{id: FactoryID},
