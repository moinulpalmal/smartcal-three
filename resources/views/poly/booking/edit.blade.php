...
@section('content')
    ...
    <div class="page page-dashboard">
        <div class="pageheader">
            <h2>Poly <span>New Booking</span></h2>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('poly.booking.edit', ['id'=> $purchaseOrder->id])}}"> Edit Booking</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <!-- tile -->
                <form method="post" id="UserCreatForm" name="UserCreatForm" action="{{route('poly.booking.update')}}" enctype="multipart/form-data" >
                    {{ csrf_field() }}
                    <section class="tile">
                        <!-- tile header -->
                                ...
                                @endif
                                    ...
                                    <div class="col-md-3 no-padding">
                                        <div class="form-group">
                                            ...
                                            <input id="GarmentsQty" type="number" min="1" class="form-control @error('garments_quantity') is-invalid @enderror" name="garments_quantity" value="{{ old('garments_quantity', $purchaseOrder->garments_quantity) }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row" style="padding: 0px 15px;">
