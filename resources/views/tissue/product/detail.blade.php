        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('tissue.product')}}"> Product Setup</a>
                    </li>
                    <li>
                        <a href="{{route('tissue.product.detail', ['id' => $product->id])}}"> {{$product->name}}</a>
                    </li>
                </ul>
            </div>
        </div>
                                                                ...
                                                                <div class="row" style="padding: 0px 15px;">
                                                                    <div class="col-md-2 no-padding">
                                                                        <div class="form-group">
                                                                            <input type="hidden" id="PSetupID" name="tissue_product_setup_id" value="{{old('tissue_product_setup_id', $product->id)}}">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-4 no-padding">
                                                                        <div class="form-group">
                                                                            <label for="FactoryName" class="control-label">Per Dozen Price (USD)</label>
                                                                            <input type="number" step="any" class="form-control" name="per_dz_price" id="FactoryName" required="">
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover table-bordered table-condensed table-responsive" id="advanced-usage">
                                                                        ...
                                                                        <tr style="background-color: #1693A5; color: white;">
                                                                            ...
                                                                            <th class="text-center">Per Dozen Price</th>
    ...
    <script>
        ...
        $(function(){
            ...
            $('#ItemAdd').submit(function(e){
                ...
                //return;
                var url = '{{ route('tissue.product.save-price-setup') }}';
                //console.log(data);
                $.ajax({
                    url: url,
                    method:'POST',
