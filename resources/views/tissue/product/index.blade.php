        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('tissue.product')}}"> Tissue</a>
                    </li>
                </ul>
            </div>
        </div>
...
{{--                                    <th class="text-center">Cartoon/Board</th>--}}
                                ...
                                @foreach($products as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a title="Conversion Rate Setup" class="btn btn-info btn-xs" href="{{route('tissue.product.detail', ['id' => $item->id])}}"><i class="fa fa-eye"></i></a>
       ...
       /* $(window).load(function(){
        ...
        $(function(){
            ...
            $('#FactoryAdd').submit(function(e){
                ...
                //console.log(data);
                var url = '{{ route('tissue.product.save') }}';
                //console.log(data);
                $.ajax({
                    url: url,
                    method:'POST',
        ...
        $('#advanced-usage').on('click',".EditFactory", function(){
            ...
            var url = '{{ route('tissue.product.edit') }}';
            $.ajax({
                url: url,
                method:'POST',
                data:{id: FactoryID},
