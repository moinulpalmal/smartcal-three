        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('tissue.booking.detail', ['id' => $master->id ])}}"> LPD PO NO: {{$master->lpd_po_no}}</a>
                    </li>
                    <li>
                        <a href="#"> Print View</a>
                    </li>
        ...
        <div class="add-nav">
            <div class="nav-heading">
                ...
                <span class="controls pull-right">
                    <a href="{{route('tissue.booking.detail', ['id' => $master->id ])}}" class="btn btn-ef btn-ef-1 btn-ef-1-default btn-ef-1a btn-rounded-20 mr-5" data-toggle="tooltip" title="Back"><i class="fa fa-times"></i></a>
...
{{--                                                        <th class="text-uppercase text-center" style=" font-size: xx-small !important;">Color</th>--}}
                                                        ...
                                                        <th class="text-uppercase text-center" style="font-size: xx-small !important;">Per DZ Unit Price</th>
                                                ...
                                                @foreach($details as $item)
                                                    @if($item->tissue_product_setup_id == $uproduct->id)
                                                        <tr style="height: 1px !important;">
                                                            ...
                                                            <td style="font-size: small !important;"><p>{!! $item->size !!}</p></td>
{{--                                                            <td style="font-size: small !important;"><p>{!! $item->color !!}</p></td>--}}
                                                            ...
                                                            <td style="font-size: small !important;" class="text-right"><P>$ {!! number_format($item->per_dz_price  , 5, '.', ',') !!}</P></td>
