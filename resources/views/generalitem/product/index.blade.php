...
@section('content')
    ...
    <div class="page page-dashboard">
        <div class="pageheader">
            <h2>General Item <span>Setup</span></h2>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('generalitem.product')}}"> General Item Setup</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <form method="post" id="FactoryAdd" enctype="multipart/form-data">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>General Item</strong> Insert/Update Form</h1>
                        ...
                        <div class="tile-body">
                            ...
                            <div class="row" style="padding: 0px 15px;">
                                ...
                                {{--<div class="col-md-3 no-padding">
                                    <div class="form-group">
                                        <label for="FullUnit" class="control-label">Per Con Length (meter)</label>
                                        <input type="number" class="form-control" name="per_con_length" id="FullUnit">
                                    </div>
                                </div>--}}
                            </div>
                        </div>
                            ...
                            <table class="table table-hover table-bordered table-condensed table-responsive" id="advanced-usage">
                                ...
                                @foreach($products as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a title="Detail Setup" class="btn btn-info btn-xs" href="{{route('generalitem.product.detail', ['id' => $item->id])}}"><i class="fa fa-eye"></i></a>
       ...
       /* $(window).load(function(){
        ...
        $(function(){
            ...
            $('#FactoryAdd').submit(function(e){
                ...
                //console.log(data);
                var url = '{{ route('generalitem.product.save') }}';
                //console.log(data);
                $.ajax({
                    url: url,
                    method:'POST',
        ...
        $('#advanced-usage').on('click',".EditFactory", function(){
            ...
            var url = '{{ route('generalitem.product.edit') }}';
            $.ajax({
                url: url,
                method:'POST',
                data:{id: FactoryID},
