...
@section('content')
    ...
    <div class="page page-profile">
        <div class="pageheader">
            <h2>General Item <span>// Detail</span></h2>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('generalitem.product')}}"> Product Setup</a>
                    </li>
                    <li>
                        <a href="{{route('generalitem.product.detail', ['id' => $product->id])}}"> {{$product->name}}</a>
                    </li>
                </ul>
            </div>
        </div>
                                                                ...
                                                                <div class="row" style="padding: 0px 15px;">
                                                                    <div class="col-md-2 no-padding">
                                                                        <div class="form-group">
                                                                            <input type="hidden" id="PSetupID" name="general_product_setup_id" value="{{old('general_product_setup_id', $product->id)}}">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-3 no-padding">
                                                                        <div class="form-group">
                                                                            <label for="FactoryName" class="control-label">Unit Price</label>
    ...
    <script>
        ...
        $(function(){
            ...
            $('#ItemAdd').submit(function(e){
                ...
                //return;
                var url = '{{ route('generalitem.product.save-price-setup') }}';
                //console.log(data);
                $.ajax({
                    url: url,
                    method:'POST',
