        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('generalitem.booking.detail', ['id' => $master->id ])}}"> LPD PO NO: {{$master->lpd_po_no}}</a>
                    </li>
                    <li>
                        <a href="#"> Print View</a>
                    </li>
        ...
        <div class="add-nav">
            <div class="nav-heading">
                ...
                <span class="controls pull-right">
                    <a href="{{route('generalitem.booking.detail', ['id' => $master->id ])}}" class="btn btn-ef btn-ef-1 btn-ef-1-default btn-ef-1a btn-rounded-20 mr-5" data-toggle="tooltip" title="Back"><i class="fa fa-times"></i></a>
                                            ...
                                            <table class="table table-hover table-condensed" id="items">
                                                ...
                                                <tr style="height: 3px !important;">
                                                    ...
                                                    <td style="font-size: small !important;" class="text-right">
                                                        <P>
                                                            <b>
                                                                {{$currency}} {!! number_format($total_price, 3, '.', ',') !!}
                                                            </b>
                                                        </P>
                                                    </td>
                                                </tr>
