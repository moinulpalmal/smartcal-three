...
@section('content')
    ...
    <div class="page page-dashboard">
        <div class="pageheader">
            <h2>General Item <span>Booking List</span></h2>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('generalitem.booking.delivery-complete')}}"> Delivery Complete Bookings</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <section class="tile">
                    ...
                    <div class="tile-header dvd dvd-btm">
                        <h1 class="custom-font"><strong>General Item</strong> Booking List</h1>
                        <ul class="controls">
                            <li class="dropdown">
