        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('elastic.product.detail', ['id' => $product->id])}}"> {{$product->name}}</a>
                    </li>
                </ul>
            </div>
        </div>
                                                                ...
                                                                <div class="row" style="padding: 0px 15px;">
                                                                    <div class="col-md-4 no-padding">
                                                                        <div class="form-group">
                                                                            <input type="hidden" id="PSetupID" name="elastic_product_setup_id" value="{{old('elastic_product_setup_id', $product->id)}}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4 no-padding">
                                                                        <div class="form-group">
    ...
    <script>
        ...
        $(function(){
            ...
            $('#ItemAdd').submit(function(e){
                ...
                //return;
                var url = '{{ route('elastic.product.save-price-setup') }}';
                //console.log(data);
                $.ajax({
                    url: url,
                    method:'POST',
