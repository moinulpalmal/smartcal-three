        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('elastic.booking.delivery-complete')}}"> Delivery Bookings</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <section class="tile">
                    ...
                    <div class="tile-header dvd dvd-btm">
                        <h1 class="custom-font"><strong>Elastic</strong> Booking List</h1>
                        <ul class="controls">
                            <li class="dropdown">
                            ...
                            <table class="table table-hover table-bordered table-condensed table-responsive" id="advanced-usage">
                                ...
                                @foreach($purchaseOrders as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a title="Detail" class="btn btn-info btn-xs" href="{{route('elastic.booking.detail', ['id' => $item->id])}}"><i class="fa fa-eye"></i></a>
