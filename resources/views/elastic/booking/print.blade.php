        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('elastic.booking.detail', ['id' => $master->id ])}}"> LPD PO NO: {{$master->lpd_po_no}}</a>
                    </li>
                    <li>
                        <a href="#"> Print View</a>
                    </li>
        ...
        <div class="add-nav">
            <div class="nav-heading">
                ...
                <span class="controls pull-right">
                    <a href="{{route('elastic.booking.detail', ['id' => $master->id ])}}" class="btn btn-ef btn-ef-1 btn-ef-1-default btn-ef-1a btn-rounded-20 mr-5" data-toggle="tooltip" title="Back"><i class="fa fa-times"></i></a>
                                    ...
                                    @foreach($uniqueProducts as $uproduct)
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover table-condensed" id="items">
                                                ...
                                                <tr style="height: 3px !important;">
                                                    <td colspan="2" style="font-size: small !important;" class="text-right"><p><b>Total:</b></p></td>
                                                    <td colspan="2" style="font-size: small !important;" class="text-right">
                                                        <P>
                                                            <b>
                                                                {!! number_format($order_quantity, 0, '.', ',') !!}
                                                            </b>
