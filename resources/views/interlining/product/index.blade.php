...
@section('content')
    ...
    <div class="page page-dashboard">
        <div class="pageheader">
            <h2>Interlining <span>Setup</span></h2>
            <div class="page-bar">
                ...
                <form method="post" id="FactoryAdd" enctype="multipart/form-data">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Interlining</strong> Insert/Update Form</h1>
                        ...
                        <div class="tile-body">
                            ...
                            <div class="row" style="padding: 0px 15px;">
                                ...
                                {{--<div class="col-md-3 no-padding">
                                    <div class="form-group">
                                        <label for="FullUnit" class="control-label">Gross Form Factor</label>
                                        <input type="number" class="form-control" name="gross_form_factor" id="FullUnit">
                                    </div>
                                </div>--}}
                            </div>
                        </div>
...
{{--                                    <th class="text-center">Gross Form Factor</th>--}}
                                ...
                                @foreach($products as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a title="Conversion Rate Setup" class="btn btn-info btn-xs" href="{{route('interlining.product.detail', ['id' => $item->id])}}"><i class="fa fa-eye"></i></a>
...
{{--                                    <td class="text-center">Gross Form Factor</td>--}}
       ...
       /* $(window).load(function(){
        ...
        $(function(){
            ...
            $('#FactoryAdd').submit(function(e){
                ...
                //console.log(data);
                var url = '{{ route('interlining.product.save') }}';
                //console.log(data);
                $.ajax({
                    url: url,
                    method:'POST',
        ...
        $('#advanced-usage').on('click',".EditFactory", function(){
            ...
            var url = '{{ route('interlining.product.edit') }}';
            $.ajax({
                url: url,
                method:'POST',
                data:{id: FactoryID},
