...
@section('content')
    ...
    <div class="page page-profile">
        <div class="pageheader">
            <h2>Interlining <span>// Detail</span></h2>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('interlining.product')}}"> Product Setup</a>
                    </li>
                    <li>
                        <a href="{{route('interlining.product.detail', ['id' => $product->id])}}"> {{$product->name}}</a>
                    </li>
                </ul>
            </div>
        </div>
                                                        ...
                                                        <section class="tile">
                                                            ...
                                                            <div class="tile-body">
                                                                <div class="row" style="padding: 0px 15px;">
                                                                    <input type="hidden" id="PSetupID" name="interlining_product_setup_id" value="{{old('interlining_product_setup_id', $product->id)}}">
                                                                    ...
                                                                    <div class="col-md-2 no-padding">
                                                                     ...
                                                                     <div class="col-md-3 no-padding">
                                                                        <div class="form-group">
                                                                             <label for="FactoryName" class="control-label">Article No</label>
                                                                            <input type="text" class="form-control" name="article_no" id="FactoryName" required="">
    ...
    <script>
        ...
        $(function(){
            ...
            $('#ItemAdd').submit(function(e){
                ...
                //return;
                var url = '{{ route('interlining.product.save-price-setup') }}';
                //console.log(data);
                $.ajax({
                    url: url,
                    method:'POST',
        ...
        $('#advanced-usage').on('click',".EditFactory", function(){
            ...
            var url = '{{ route('interlining.product.edit-price-setup') }}';
            $.ajax({
                url: url,
                method:'POST',
                data:{id: FactoryID},
                success:function(data){
                    $('input[name=interlining_product_setup_id]').val(data.interlining_product_setup_id);
                    ...
                    $("#CurrencyID option[value = '" + data.currency + "']").attr('selected', 'selected').change();
        ...
        $('#advanced-usage').on('click',".DeleteDetail", function(){
            ...
            var url = '{{ route('interlining.product.delete-price-setup') }}';
            swal({
                title: 'Are you sure?',
