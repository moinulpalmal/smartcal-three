...
class CreateTissuePurchaseOrderDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tissue_purchase_order_details', function (Blueprint $table) {
            ...
            $table->string('order_quantity_dz', 80)->nullable();
            $table->string('per_dz_price', 80)->nullable();
    ...
    {
        Schema::dropIfExists('tissue_purchase_order_details');
    }
}
