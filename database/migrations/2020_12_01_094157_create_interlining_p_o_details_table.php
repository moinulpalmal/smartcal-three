...
class CreateInterliningPODetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('interlining_p_o_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('interlining_p_o_details');
    }
}
