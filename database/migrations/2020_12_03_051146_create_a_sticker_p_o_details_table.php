...
class CreateAStickerPODetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('a_sticker_p_o_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('a_sticker_p_o_details');
    }
}
